 ...
 */
@JsonPropertyOrder({
  ContestStarted.JSON_PROPERTY_METADATA,
  ContestStarted.JSON_PROPERTY_OBJECT_TYPE,
  ContestStarted.JSON_PROPERTY_CONSTRAINTS,
  ContestStarted.JSON_PROPERTY_ACCOUNT_ID,
  ContestStarted.JSON_PROPERTY_SPACE_NAME,
  ContestStarted.JSON_PROPERTY_CONTEST_ID,
  ContestStarted.JSON_PROPERTY_CONTEST_NAME
})
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class ContestStarted {
  ...
  public ContestStarted metadata(Map<String, String> metadata) {
    this.metadata = metadata;
    return this;
  }

  public ContestStarted putMetadataItem(String key, String metadataItem) {
  ...
  **/
  ...
  public ContestStarted objectType(String objectType) {
  ...
  **/
  ...
  public ContestStarted constraints(List<String> constraints) {
    this.constraints = constraints;
    return this;
  }

  public ContestStarted addConstraintsItem(String constraintsItem) {
  ...
  **/
  ...
  public ContestStarted accountId(String accountId) {
  ...
  **/
  ...
  public ContestStarted spaceName(String spaceName) {
  ...
  **/
  ...
  public ContestStarted contestId(String contestId) {
  ...
  **/
  ...
  public ContestStarted contestName(String contestName) {
  ...
  **/
  ...
  /**
   * Return true if this ContestStarted object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ContestStarted contestStarted = (ContestStarted) o;
    return Objects.equals(this.metadata, contestStarted.metadata) &&
        Objects.equals(this.objectType, contestStarted.objectType) &&
        Objects.equals(this.constraints, contestStarted.constraints) &&
        Objects.equals(this.accountId, contestStarted.accountId) &&
        Objects.equals(this.spaceName, contestStarted.spaceName) &&
        Objects.equals(this.contestId, contestStarted.contestId) &&
        Objects.equals(this.contestName, contestStarted.contestName);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContestStarted {\n");
