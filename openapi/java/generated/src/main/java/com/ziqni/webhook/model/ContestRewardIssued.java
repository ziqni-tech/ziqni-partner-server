 ...
 */
@JsonPropertyOrder({
  ContestRewardIssued.JSON_PROPERTY_METADATA,
  ContestRewardIssued.JSON_PROPERTY_OBJECT_TYPE,
  ContestRewardIssued.JSON_PROPERTY_CONSTRAINTS,
  ContestRewardIssued.JSON_PROPERTY_ACCOUNT_ID,
  ContestRewardIssued.JSON_PROPERTY_SPACE_NAME,
  ContestRewardIssued.JSON_PROPERTY_AWARD_ID,
  ContestRewardIssued.JSON_PROPERTY_REWARD_ID,
  ContestRewardIssued.JSON_PROPERTY_REWARD_TYPE_KEY,
  ContestRewardIssued.JSON_PROPERTY_REWARD_TYPE_ID,
  ContestRewardIssued.JSON_PROPERTY_REWARD_META_DATA,
  ContestRewardIssued.JSON_PROPERTY_VALUE,
  ContestRewardIssued.JSON_PROPERTY_MEMBER_REF_ID,
  ContestRewardIssued.JSON_PROPERTY_MEMBER_ID,
  ContestRewardIssued.JSON_PROPERTY_REWARD_NAME,
  ContestRewardIssued.JSON_PROPERTY_CONTEST_ID,
  ContestRewardIssued.JSON_PROPERTY_CONTEST_NAME
})
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class ContestRewardIssued {
  ...
  public ContestRewardIssued metadata(Map<String, String> metadata) {
    this.metadata = metadata;
    return this;
  }

  public ContestRewardIssued putMetadataItem(String key, String metadataItem) {
  ...
  **/
  ...
  public ContestRewardIssued objectType(String objectType) {
  ...
  **/
  ...
  public ContestRewardIssued constraints(List<String> constraints) {
    this.constraints = constraints;
    return this;
  }

  public ContestRewardIssued addConstraintsItem(String constraintsItem) {
  ...
  **/
  ...
  public ContestRewardIssued accountId(String accountId) {
  ...
  **/
  ...
  public ContestRewardIssued spaceName(String spaceName) {
  ...
  **/
  ...
  public ContestRewardIssued awardId(String awardId) {
  ...
  **/
  ...
  public ContestRewardIssued rewardId(String rewardId) {
  ...
  **/
  ...
  public ContestRewardIssued rewardTypeKey(String rewardTypeKey) {
  ...
  **/
  ...
  public ContestRewardIssued rewardTypeId(String rewardTypeId) {
  ...
  **/
  ...
  public ContestRewardIssued rewardMetaData(Map<String, String> rewardMetaData) {
    this.rewardMetaData = rewardMetaData;
    return this;
  }

  public ContestRewardIssued putRewardMetaDataItem(String key, String rewardMetaDataItem) {
  ...
  **/
  ...
  public ContestRewardIssued value(Double value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public ContestRewardIssued memberRefId(String memberRefId) {
  ...
  **/
  ...
  public ContestRewardIssued memberId(String memberId) {
  ...
  **/
  ...
  public ContestRewardIssued rewardName(String rewardName) {
  ...
  **/
  ...
  public ContestRewardIssued contestId(String contestId) {
  ...
  **/
  ...
  public ContestRewardIssued contestName(String contestName) {
  ...
  **/
  ...
  /**
   * Return true if this ContestRewardIssued object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ContestRewardIssued contestRewardIssued = (ContestRewardIssued) o;
    return Objects.equals(this.metadata, contestRewardIssued.metadata) &&
        Objects.equals(this.objectType, contestRewardIssued.objectType) &&
        Objects.equals(this.constraints, contestRewardIssued.constraints) &&
        Objects.equals(this.accountId, contestRewardIssued.accountId) &&
        Objects.equals(this.spaceName, contestRewardIssued.spaceName) &&
        Objects.equals(this.awardId, contestRewardIssued.awardId) &&
        Objects.equals(this.rewardId, contestRewardIssued.rewardId) &&
        Objects.equals(this.rewardTypeKey, contestRewardIssued.rewardTypeKey) &&
        Objects.equals(this.rewardTypeId, contestRewardIssued.rewardTypeId) &&
        Objects.equals(this.rewardMetaData, contestRewardIssued.rewardMetaData) &&
        Objects.equals(this.value, contestRewardIssued.value) &&
        Objects.equals(this.memberRefId, contestRewardIssued.memberRefId) &&
        Objects.equals(this.memberId, contestRewardIssued.memberId) &&
        Objects.equals(this.rewardName, contestRewardIssued.rewardName) &&
        Objects.equals(this.contestId, contestRewardIssued.contestId) &&
        Objects.equals(this.contestName, contestRewardIssued.contestName);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContestRewardIssued {\n");
